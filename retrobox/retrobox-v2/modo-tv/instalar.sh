...
## FECHAS DE MODIFICACIÓN: 28 de octubre de 2020, 3 de septiembre de 2021
...
function instalar(){
	...
	unzip "$ROOTDIR/modo-tv.zip" -d "$HOME/.local/lib/modo-tv" || error No se han podido copiar los datos del ModoTV
